...
use Modules\\$MODULE_NAME\Requests\Store${MODULE_NAME}Request;
use Modules\\$MODULE_NAME\Requests\Update${MODULE_NAME}Request;
use Modules\\$MODULE_NAME\Resources\\${MODULE_NAME}Resource;
...
namespace Modules\\$MODULE_NAME\Requests;
...
namespace Modules\\$MODULE_NAME\Resources;
...
use Modules\\$MODULE_NAME\Controllers\\${MODULE_NAME}Controller;
